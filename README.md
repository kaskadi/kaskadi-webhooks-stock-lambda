![](https://img.shields.io/github/package-json/v/kaskadi/kaskadi-webhooks-stock-lambda)
...
- create a new repository and choose this repository (`kaskadi-webhooks-stock-lambda`) as template
